...
create table CUENTAS (numero bigint generated by default as identity, descubiertoAcordado double, fechaDeCierre date, fechaDeCreacion date not null, saldoActual double not null, saldoInicial double, titular_Id bigint not null, primary key (numero));
